...
# This integer is used to keep track of the state of the system
...
global stateOfSystem
stateOfSystem = str(0)
# This integer is used to keep track of the state of the Warthog's battery
...
# This int is used to track the current row number
# It is used when filling in the time stamp table. Tells what row to reference
global rowCounter
rowCounter = 0
# This int is used to track the current column number
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # self.bldg1Label = QtWidgets.QLabel(self.centralwidget)
        # self.bldg1Label.setGeometry(QtCore.QRect(560, 640, 191, 101))
        # font = QtGui.QFont()
        # font.setFamily("Times New Roman")
        # font.setPointSize(20)
        # font.setBold(True)
        # font.setWeight(75)
        # self.bldg1Label.setFont(font)
        # self.bldg1Label.setAutoFillBackground(False)
        # self.bldg1Label.setStyleSheet("background-color: rgb(3, 221, 255);")
        # self.bldg1Label.setFrameShape(QtWidgets.QFrame.WinPanel)
        # self.bldg1Label.setFrameShadow(QtWidgets.QFrame.Plain)
        # self.bldg1Label.setLineWidth(1)
        # self.bldg1Label.setMidLineWidth(0)
        # self.bldg1Label.setTextFormat(QtCore.Qt.AutoText)
        # self.bldg1Label.setAlignment(QtCore.Qt.AlignCenter)
        # self.bldg1Label.setWordWrap(False)
        # self.bldg1Label.setObjectName("bldg1Label")
...
#         self.bldg2Label = QtWidgets.QLabel(self.centralwidget)
#         self.bldg2Label.setGeometry(QtCore.QRect(1010, 640, 191, 101))
#         font = QtGui.QFont()
#         font.setFamily("Times New Roman")
#         font.setPointSize(20)
#         font.setBold(True)
#         font.setWeight(75)
#         self.bldg2Label.setFont(font)
#         self.bldg2Label.setAutoFillBackground(False)
#         self.bldg2Label.setStyleSheet("background-color: rgb(3, 221, 255);\n"
# "background-color: rgb(0, 255, 30);")
#         self.bldg2Label.setFrameShape(QtWidgets.QFrame.WinPanel)
#         self.bldg2Label.setFrameShadow(QtWidgets.QFrame.Plain)
#         self.bldg2Label.setLineWidth(1)
#         self.bldg2Label.setMidLineWidth(0)
#         self.bldg2Label.setTextFormat(QtCore.Qt.AutoText)
#         self.bldg2Label.setAlignment(QtCore.Qt.AlignCenter)
#         self.bldg2Label.setWordWrap(False)
#         self.bldg2Label.setObjectName("bldg2Label")

#         self.bldg3Label = QtWidgets.QLabel(self.centralwidget)
#         self.bldg3Label.setGeometry(QtCore.QRect(860, 830, 191, 101))
#         font = QtGui.QFont()
#         font.setFamily("Times New Roman")
#         font.setPointSize(20)
#         font.setBold(True)
#         font.setWeight(75)
#         self.bldg3Label.setFont(font)
#         self.bldg3Label.setAutoFillBackground(False)
#         self.bldg3Label.setStyleSheet("background-color: rgb(3, 221, 255);\n"
# "background-color: rgb(255, 200, 0);")
#         self.bldg3Label.setFrameShape(QtWidgets.QFrame.WinPanel)
#         self.bldg3Label.setFrameShadow(QtWidgets.QFrame.Plain)
#         self.bldg3Label.setLineWidth(1)
#         self.bldg3Label.setMidLineWidth(0)
#         self.bldg3Label.setTextFormat(QtCore.Qt.AutoText)
#         self.bldg3Label.setAlignment(QtCore.Qt.AlignCenter)
#         self.bldg3Label.setWordWrap(False)
#         self.bldg3Label.setObjectName("bldg3Label")
        ...
        ##
        # self.atPickupLocationBtn = QtWidgets.QPushButton(self.centralwidget)
        # self.atPickupLocationBtn.setGeometry(QtCore.QRect(1320, 140, 231, 51))
        # font = QtGui.QFont()
        # font.setPointSize(10)
        # font.setBold(False)
        # font.setWeight(50)
        # self.atPickupLocationBtn.setFont(font)
        # self.atPickupLocationBtn.setObjectName("atPickupLocationBtn")
        ##
        ...
        ##
        # self.deliveredBtn = QtWidgets.QPushButton(self.centralwidget)
        # self.deliveredBtn.setGeometry(QtCore.QRect(1320, 210, 231, 51))
        # font = QtGui.QFont()
        # font.setPointSize(10)
        # font.setBold(False)
        # font.setWeight(50)
        # self.deliveredBtn.setFont(font)
        # self.deliveredBtn.setObjectName("deliveredBtn")
        ##
        ...
        ##
        # self.atChargingStationBtn = QtWidgets.QPushButton(self.centralwidget)
        # self.atChargingStationBtn.setGeometry(QtCore.QRect(1320, 280, 231, 51))
        # font = QtGui.QFont()
        # font.setPointSize(10)
        # font.setBold(False)
        # font.setWeight(50)
        # self.atChargingStationBtn.setFont(font)
        # self.atChargingStationBtn.setObjectName("atChargingStationBtn")
        ## 
        ...
        # self.locationsLabel = QtWidgets.QLabel(self.centralwidget)
        # self.locationsLabel.setGeometry(QtCore.QRect(1370, 100, 131, 31))
        # font = QtGui.QFont()
        # font.setPointSize(12)
        # font.setBold(False)
        # font.setWeight(50)
        # self.locationsLabel.setFont(font)
        # self.locationsLabel.setAlignment(QtCore.Qt.AlignCenter)
        # self.locationsLabel.setObjectName("locationsLabel")
...
# Button triggers here
        # self.requestBtn.pressed.connect(lambda: self.pressed("Status: Picking Up at 1"))
        ...
        # self.atPickupLocationBtn.pressed.connect(lambda: self.pressed("Status: Needs loading"))
        self.loadPalletBtn.pressed.connect(lambda: self.pressed("Status: Delivering to " + delivLoc))
        # self.deliveredBtn.pressed.connect(lambda: self.pressed("Status: Needs unloading"))
        self.unloadPalletBtn.pressed.connect(lambda: self.pressed("Status: Navigating to charging station"))
        # self.atChargingStationBtn.pressed.connect(lambda: self.pressed("Status: Needs plugging in"))
...
# end button triggers 
    ...
    def retranslateUi(self, MainWindow):
        ...
        # self.bldg1Label.setText(_translate("MainWindow", "Building 1"))
        ...
        # self.bldg2Label.setText(_translate("MainWindow", "Building 2"))
        # self.bldg3Label.setText(_translate("MainWindow", "Building 3"))
        ...
        # self.atPickupLocationBtn.setText(_translate("MainWindow", "At Pickup Location"))
        self.loadPalletBtn.setText(_translate("MainWindow", "Load Pallet"))
        # self.deliveredBtn.setText(_translate("MainWindow", "Delivered"))
        self.unloadPalletBtn.setText(_translate("MainWindow", "Unload Pallet"))
        # self.atChargingStationBtn.setText(_translate("MainWindow", "At Charging Station"))
        ...
        # self.locationsLabel.setText(_translate("MainWindow", "Locations"))
    ...
    def pressed(self, text):
        ...
        # Attends the next delivery if it has finished the previous delivery and has enough battery to do so
        ...
        # Goes to charging station if insufficient battery is read during delivery process
            ...
            if      stateOfSystem == "0" and btnPressed == True and \
                ...
                batteryStatus = 0
                btnPressed = False
            # Handles case when the battery goes to0 low after sitting in the "Needs unplugging" state for too long
...
#     def testyWesty():
#         statusLabel.setText("Status: Picking Up at " + pickupLoc)
...
#         print(statusLabel.text())
    ...
    def popup_window(self, text):
        ...
        if stateOfSystem == "2" and self.statusLabel.text() == "Status: Picking Up at " + pickupLoc and text == "Status: Navigation to pickup location failed":
            ...
            # pickupFailMsg.setDetailedText("Navigation to Building " + pickupLoc + " has failed. Please use Futaba controller to guide Warthog back to charging station ASAP.")
...
# def testyWesty():
#     print('inside')
#     ui.statusLabel.setText("Status: Picking Up at ")
#     print('inside 2')
...
#     MainWindow.show()
#     print('inside 5')
#     #print(Ui_MainWindowstatusLabel.text())

sys.exit(app.exec_())

# while(atLocation == False):
#     building1status = self.checkGPS()
#     #building1status = self.checkBldg1()
#     print(building1status)
#     if building1status == 1:
#         atLocation = True